...
<div class="menu-bar">
    ...
    <ul>
        <li><a href="#">Hello <%=voter.getUsername()%></a></li>
        <li><a href="VoterProfile.jsp">Profile</a></li>
        <li><a href="GiveVote.jsp">Give Vote</a></li>
        <li><a href="VViewResult.jsp">See Result</a></li>
        <li><a href="NID.jsp" >View NID Card</li>
        <li><a href="logoutvoter">Logout</a></li>
    </ul>
</div>
